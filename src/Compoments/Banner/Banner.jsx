           ...
           <div className=" lg:w-[597px] m-auto">
              <div className="">
                ...
                <div className="flex justify-center items-center mt-5">
                    <button onClick={openPlayStore} className="btn text-[#001931] font-semibold text-xl"> <img src={google} alt="" />Google Play</button>
                    <button onClick={openAppStore} className="btn text-[#001931] font-semibold text-xl ml-2"> <img src={apps} alt="" />App Store</button>
